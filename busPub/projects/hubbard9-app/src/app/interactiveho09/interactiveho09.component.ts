...
@Component({
  selector: 'app-interactiveho09',
  standalone: true,
  imports: [CommonModule, BusPubLibModule, ReactiveFormsModule],
  templateUrl: './interactiveho09.component.html',
  styleUrls: ['./interactiveho09.component.scss']
})
export class Interactiveho09Component implements OnInit, AfterViewInit {
