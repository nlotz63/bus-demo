...
@Component({
  selector: 'app-interactiveho06',
  standalone: true,
  imports: [CommonModule, MatRadioModule, BusPubLibModule],
  templateUrl: './interactiveho06.component.html',
  styleUrls: ['./interactiveho06.component.scss'],
  animations: [
...
export class Interactiveho06Component implements OnInit, AfterViewInit {
