...
@Component({
  selector: 'app-interactiveho12',
  standalone: true,
  imports: [CommonModule, BusPubLibModule],
  templateUrl: './interactiveho12.component.html',
  styleUrls: ['./interactiveho12.component.scss'],
  animations: [
...
export class Interactiveho12Component implements OnInit, AfterViewInit {
