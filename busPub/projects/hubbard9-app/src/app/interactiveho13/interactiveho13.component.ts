...
@Component({
  selector: 'app-interactiveho13',
  standalone: true,
  imports: [CommonModule, MatRadioModule, BusPubLibModule, MatSlideToggleModule],
  templateUrl: './interactiveho13.component.html',
  styleUrls: ['./interactiveho13.component.scss'],
  animations: [
...
export class Interactiveho13Component implements OnInit, AfterViewInit {
