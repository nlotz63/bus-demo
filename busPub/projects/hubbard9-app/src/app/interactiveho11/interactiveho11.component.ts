...
@Component({
  selector: 'app-interactiveho11',
  standalone: true,
  imports: [CommonModule, BusPubLibModule],
  templateUrl: './interactiveho11.component.html',
  styleUrls: ['./interactiveho11.component.scss'],
  animations: [
...
export class Interactiveho11Component implements OnInit, AfterViewInit {
