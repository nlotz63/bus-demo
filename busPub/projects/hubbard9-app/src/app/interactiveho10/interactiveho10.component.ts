...
@Component({
  selector: 'app-interactiveho10',
  standalone: true,
  imports: [CommonModule, BusPubLibModule, MatButtonModule],
  templateUrl: './interactiveho10.component.html',
  styleUrls: ['./interactiveho10.component.scss'],
  animations: [
...
export class Interactiveho10Component implements OnInit, AfterViewInit {
